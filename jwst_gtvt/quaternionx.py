...
def QX(angle):
   ...
   return Quaternion(rot.Vector(math.sin(-angle/2.),0.,0.),math.cos(angle/2.))
def QY(angle):
   """Creates rotation quaternion about Y axis, assuming coordinate frame is rotated"""
   return Quaternion(rot.Vector(0.,math.sin(-angle/2.),0.),math.cos(angle/2.))
def QZ(angle):
   """Creates rotation quaternion about Z axis, assuming coordinate frame is rotated"""
   return Quaternion(rot.Vector(0.,0.,math.sin(-angle/2.)),math.cos(angle/2.))
